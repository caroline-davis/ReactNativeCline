...
const countriesFoods = [
  {
    ...
    food: 'Asado',
    description:
      'A traditional barbecue technique and social event where various types of meat are grilled.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Feijoada',
    description:
      'A hearty stew of black beans, pork, and beef traditionally served with rice, collard greens, and orange slices.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Peking Duck',
    description:
      'A famous dish from Beijing, featuring crispy-skinned roasted duck served with thin pancakes and condiments.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Smørrebrød',
    description:
      'An open-faced sandwich made with rye bread, typically topped with various ingredients like fish, meats, and vegetables.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Kushari',
    description:
      'A popular street food combining rice, lentils, pasta, and a spicy tomato sauce.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Moussaka',
    description:
      'A layered casserole with eggplant, ground meat, and a creamy béchamel sauce.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Goulash',
    description:
      'A savory beef stew with paprika, vegetables, and a rich, hearty broth.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Butter Chicken',
    description:
      'A creamy, mildly spiced curry with tender chicken in a tomato-based sauce.',
    recipe: [
  ...
  },
  {
    ...
    food: 'Sushi',
    description:
      'A traditional Japanese dish of vinegared rice combined with raw fish, vegetables, and sometimes tropical fruits.',
    recipe: [
